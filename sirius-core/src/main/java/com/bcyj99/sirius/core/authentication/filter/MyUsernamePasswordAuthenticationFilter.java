...
public class MyUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter{
	...
	public static final String SPRING_SECURITY_FORM_VALIDATECODE_KEY = "validateCode";
	
	public static final Logger logger = LoggerFactory.getLogger(MyUsernamePasswordAuthenticationFilter.class);
	...
	public Authentication attemptAuthentication(HttpServletRequest request,
		...
		if(SiriusStringUtils.isBlank(validateCode)){
			throw new BadCredentialsException(messages.getMessage(
					"MyUsernamePasswordAuthenticationFilter.validateCodeIsNotEmpty",
					"Bad credentials1"));
		}else{
			...
			if(!validateCode.equalsIgnoreCase(kaptcha)){
				throw new BadCredentialsException(messages.getMessage(
						"MyUsernamePasswordAuthenticationFilter.validateCodeMismatch",
						"Bad credentials2"));
			}
		}
